...
#%%
all_files = [pd.read_csv(f'/home/laiminzhi/new_data/predict_data/y1_label__all_minmax_no_ud_limit_h2/selected_feature(all)_loss(mse)_depth4_sizes(249_128_128_1)_bd_valid/{f}',
                         dtype={'date':str})for f in sorted(os.listdir('/home/laiminzhi/new_data/predict_data/y1_label__all_minmax_no_ud_limit_h2/selected_feature(all)_loss(mse)_depth4_sizes(249_128_128_1)_bd'))]
#%%
